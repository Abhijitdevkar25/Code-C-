...
class salesmanager :public wageemp
{
 ...
 int main()
 {
 	emp * p1 =new emp(100);
    p1->findsalary();
    cout<<"salary of emp is  : "<<p1->findsalary()<<endl;
	
	p1 =new wageemp(100,10,15);
   p1->findsalary();
   cout<<"salary of wageemp is  : "<<p1->findsalary()<<endl;

	
	 p1 =new salesmanager(100,10,12,2500,20);
   p1->findsalary();
cout<<"salary of salesmanager is  : "<<p1->findsalary()<<endl;
